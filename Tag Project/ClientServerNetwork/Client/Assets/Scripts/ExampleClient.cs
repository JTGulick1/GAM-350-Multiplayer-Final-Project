...
public class ExampleClient : MonoBehaviour
{
    ...
    public GameObject myPlayer; // which player is me
    public GameObject[] Players; // collect all of my players
    private Player thisPlayer; // testing
    ...
    {
        thisPlayer.GotTagged(true); // Testing
    }
    public void GotUnTagged()
    {
        thisPlayer.GotTagged(false); // Testing 
    }
}
